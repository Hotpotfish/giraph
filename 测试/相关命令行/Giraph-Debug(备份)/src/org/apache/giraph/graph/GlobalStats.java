...
public class GlobalStats implements Writable {
  ...
  //oury
  private double computedVertexCount = 0;
  ...
  //oury
  public double getComputedVertexCount()
  {
  ...
  //oury
  public void addSum(double lover) {
	  this.computedVertexCount += lover / 2;
  }
  ...
  public void readFields(DataInput input) throws IOException {
    ...
    //oury
    computedVertexCount = input.readDouble();
  }
  ...
  public void write(DataOutput output) throws IOException {
    ...
    //oury
    output.writeDouble(computedVertexCount);
  }
  ...
  public String toString() {
    return "(vtx=" + vertexCount + ",finVtx=" +
        ...
        "\nthe sum of computedVertexCount is " + computedVertexCount;
  }
}
